    ...
    <Layout>
      ...
      <TableContainer className="mb-8">
        {/* <Table>
          ...
          <TableBody>
            {displayedReasons.map((reason: reasonForm) => (
      ...
      {/* <Modal isOpen={isModalOpen} onClose={closeModal}>
        <ModalHeader>Cadastro de Motivos</ModalHeader>
        <ModalBody>
          Motivo de reclamação cadastrado com sucesso!
        </ModalBody>
        <ModalFooter>
