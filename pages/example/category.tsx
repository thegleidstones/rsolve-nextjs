...
function Category() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const response = await fetch("http://localhost:3344/categories", {
        method: "POST",
        headers: {
  ...
  return (
    <Layout>
      <PageTitle>Categoria de Denúncia</PageTitle>
        ...
        <div className="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
          ...
          <Label>
            ...
            <Input 
              ...
              onChange={handleChange}
              className="mt-1" 
              placeholder="Informe a descrição com mais detalhes sobre a categoria" 
            />
          </Label>               
